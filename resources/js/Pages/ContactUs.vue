            ...
            <div class="bg-white rounded-[20px] shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-8 sm:p-10">
                    <div v-if="submitted" class="bg-green-50 border border-green-200 rounded-[12px] p-6 text-center">
                        <div class="bg-green-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-green-600">
                        ...
                        <button @click="submitted = false" class="mt-6 text-[#1866ed] font-bold hover:underline">Send another message</button>
                    </div>
                    ...
                    <div class="mt-12 pt-10 border-t border-gray-100 grid grid-cols-1 sm:grid-cols-3 gap-8">
                        <div class="text-center">
                            <div class="bg-gray-50 w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 text-[#1866ed]">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                            </div>
                            <h3 class="font-bold text-gray-900 text-sm mb-1">Email Us</h3>
                            <p class="text-gray-500 text-xs">support@solopark.ca</p>
                        </div>
                        <div class="text-center">
                            <div class="bg-gray-50 w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 text-[#1866ed]">
                            ...
                            <p class="text-gray-500 text-xs">Toronto, ON, Canada</p>
                        </div>
                        <div class="text-center">
                            <div class="bg-gray-50 w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 text-[#1866ed]">
