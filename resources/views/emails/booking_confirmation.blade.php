...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Your parking reservation has been successfully confirmed. Please see the details below for your visit.
            </p>

            <div class="details">
                <h3 style="margin-top: 0; color: #1866ed;">{{ $booking->spot->title }}</h3>
                <p style="color: #6b7280; font-size: 14px;">{{ $booking->spot->address }}, {{ $booking->spot->city }}
                </p>
                ...
                <div class="detail-row">
                    ...
                    <span>CA${{ number_format($booking->total_price - $booking->tax, 0) }}</span>
                </div>
                <div class="detail-row">
            ...
            <p><strong>Host:</strong> {{ $booking->spot->user->name }}<br><strong>Email:</strong>
                {{ $booking->spot->user->email }}</p>
